...
<body>
				...
				<img src="images/apply/congratulation.png" class="congra"><br>
						<label class="apply_suc_panel_label" style="color: #333;"><%=request.getAttribute("tName")%></label><br>
							<span class="apply_suc_panel_span" style="color: #333;"><%=request.getAttribute("tBelonging")%></span><span class="apply_suc_panel_span" style="color: #333;">队长：<%=request.getAttribute("pName")%></span><br>
								<div class="apply_suc_panel_aside GRa">非常感谢您的耐心注册，并恭喜您的队伍已完成第一步报名任务！</div><br>
								<div class="GRb">
	...
	<div class="skin_list shadow_a">
		<div class="skin_list_div">
			<img src="images/hero_skin/45_1.jpg" class="shadow_b skin_list_img"> <img src="images/hero_skin/39_1.jpg"
				class="shadow_b skin_list_img"> <img
					src="images/hero_skin/39_2.jpg" class="shadow_b skin_list_img"> <img src="images/hero_skin/23_1.jpg"
						class="shadow_b skin_list_img"> <img
							src="images/hero_skin/23_2.jpg" class="shadow_b skin_list_img">
		</div>
	</div>
</body>
