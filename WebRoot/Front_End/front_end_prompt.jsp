		...
		<div class="prompt_panel shadow_b">
			...
			<div class="prompt_bg">
				<div class="prompt_bg_header">
					<img src="images/apply/error_title.png" class="error_title">
						<br>
							<div class="prompt_bg_article">
								...
								%>
								<%=eRemind%></div> <img src="images/apply/than_todo.png"
							class="than_todo">
								<div class="eTodo_msg">
									<%
										switch (eCodes) {
				...
				<div class="prompt_con">
					<img src="images/apply/phone.png" class="shadow_a1 prompt_con_img"></img>
					<img src="images/apply/weixin.png" class="shadow_a1 prompt_con_img"></img>
					<img src="images/apply/weibo.png" class="shadow_a1 prompt_con_img"></img>
				</div>
